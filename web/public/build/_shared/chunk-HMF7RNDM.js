...
function PageLink({
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(import_react_router_dom.NavLink, {
    ...
    className: `uppercase mx-2 text-lg px-8 text-left text-slate-00 font-light hover:text-yellow-600 hover:border-yellow-600 transition-colors ${match ? "text-xl" : ""}`
  }, children)));
}
function Header() {
...
//# sourceMappingURL=/build/_shared/chunk-HMF7RNDM.js.map
