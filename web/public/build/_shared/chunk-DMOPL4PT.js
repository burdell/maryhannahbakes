...
function PageLink({ children, ...props }) {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "uppercase mx-2 text-lg text-left text-slate-00 font-light hover:text-yellow-600 hover:border-yellow-600 transition-colors"
  }, children)));
}
function Header() {
  return /* @__PURE__ */ React.createElement("div", {
...
//# sourceMappingURL=/build/_shared/chunk-DMOPL4PT.js.map
