...
function PageLink({ children, ...props }) {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "uppercase mx-2 text-lg px-10 py-2 text-left text-slate-00 font-light hover:text-yellow-600 hover:border-yellow-600 transition-colors"
  }, children)));
}
function Header() {
  return /* @__PURE__ */ React.createElement("div", {
...
//# sourceMappingURL=/build/_shared/chunk-O7JBNSZN.js.map
