...
function PageLink({
  ...
  var _a;
  const match = (0, import_react_router_dom.useMatch)((_a = props.to) != null ? _a : "");
  console.log(match);
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(import_react_router_dom.NavLink, {
    ...
    className: "uppercase mx-2 text-lg px-8 text-left text-slate-00 font-light hover:text-yellow-600 hover:border-yellow-600 transition-colors"
  }, children)));
}
function Header() {
...
//# sourceMappingURL=/build/_shared/chunk-OUGEIJBT.js.map
