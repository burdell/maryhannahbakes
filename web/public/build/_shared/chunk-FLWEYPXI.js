...
function PageLink({
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(import_react_router_dom.NavLink, {
    ...
    className: `uppercase mx-2 text-lg px-8 text-left text-slate-00 font-light hover:text-yellow-600 transition-colors ${match ? "border-b-2 border-yellow-600" : "border-b-2 border-none"}`
  }, children)));
}
function Header() {
...
//# sourceMappingURL=/build/_shared/chunk-FLWEYPXI.js.map
