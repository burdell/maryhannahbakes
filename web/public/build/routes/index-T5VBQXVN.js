...
function PageLink({ children, ...props }) {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(import_react_router_dom.Link, {
    ...
    className: "border rounded-sm border-solid border-slate-700 mx-2 text-2xl px-10 py-1 mb-6 text-center text-slate-00 font-light hover:text-yellow-600 hover:border-yellow-600 transition-colors"
  }, children)));
}
function Index() {
...
//# sourceMappingURL=/build/routes/index-T5VBQXVN.js.map
