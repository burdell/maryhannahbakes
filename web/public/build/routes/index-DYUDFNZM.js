...
function PageLink({ children, ...props }) {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(import_react_router_dom.Link, {
    ...
    className: " mx-2 text-2xl border-2 border-solid border-slate-700 px-10 py-2 mb-6 text-center text-slate-00 font-light hover:text-yellow-600 hover:border-yellow-600 transition-colors"
  }, children)));
}
function Index() {
...
//# sourceMappingURL=/build/routes/index-DYUDFNZM.js.map
