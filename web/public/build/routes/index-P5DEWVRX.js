...
function PageLink({ children, ...props }) {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", {
    className: "uppercase mx-2 text-2xl border-2 border-solid border-slate-700 px-5 py-2 mb-6 text-center font-semibold text-slate-700"
...
function Index() {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "font-sans flex-1 flex justify-center mt-14 flex-col sm:flex-row"
...
//# sourceMappingURL=/build/routes/index-P5DEWVRX.js.map
